...
const Checkout = () => {
  ...
  // 🎯 NEW: State for Points Redemption
  const [usePoints, setUsePoints] = useState(false);

  // 🎯 NEW: Get User Data (Points)
  ...
  const handlePayment = (e) => {
    ...
    setTimeout(() => {
      ...
      alert(
        usePoints
          ? "Points Redeemed! Order Successful."
    ...
    <div className="bg-cream min-h-screen pt-32 pb-20 font-serif">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="mb-16 border-b border-sand pb-8">
          ...
          <h1 className="text-5xl text-earth-dark italic">Checkout</h1>
        </div>
          ...
          <div className="sticky top-40">
            ...
            <div className="mb-8 p-6 border border-sand bg-white/20 backdrop-blur-sm">
              <div className="flex justify-between items-start mb-6">
                <div>
                  ...
                  <p className="text-xs text-earth-dark italic">
                    Balance: <span className="font-bold">{userPoints} pts</span>
                  </p>
                </div>
              ...
              {isSufficient ? (
                ...
                >
                  {usePoints ? "Redemption Applied ✓" : "Apply Points to Order"}
                </button>
              ) : (
            ...
            <p className="mt-6 text-[10px] text-gray-400 italic text-center uppercase tracking-widest">
              Secured by L'Olive Organic encryption
            </p>
          </div>
        </div>
      </div>
